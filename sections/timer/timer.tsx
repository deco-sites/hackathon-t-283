...
export default function CampaingTimer({ title, hora, minuto, segundo }: Props) {
  return (
    <div class="w-full h-32 bg-red-400 flex flex-col content-center justify-around items-center font-sans font-normal text-white  lg:h-24 lg:flex-row  justify-between px-20 ">
